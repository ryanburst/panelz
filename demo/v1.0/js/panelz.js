...
var Settings = function (_EventClass2) {
    _inherits(Settings, _EventClass2);

    function Settings() {
        _classCallCheck(this, Settings);

        var _this2 = _possibleConstructorReturn(this, (Settings.__proto__ || Object.getPrototypeOf(Settings)).call(this));
        ...
        _this2.localSettings = _this2.getLocalSettings();
        _this2.loadConfig($.extend({}, _this2.DEFAULTS, _this2.getUserSettings()));
        _this2.setFields();
...
var Tutorial = function (_EventClass3) {
    _inherits(Tutorial, _EventClass3);

    function Tutorial(settings) {
        _classCallCheck(this, Tutorial);

        var _this3 = _possibleConstructorReturn(this, (Tutorial.__proto__ || Object.getPrototypeOf(Tutorial)).call(this));

        _this3.settings = settings;

        _this3.interactable = new Hammer.Manager($('.tutorial')[0]);
        _this3.interactable.add(new Hammer.Swipe());

        _this3.addEventListeners();

        if (_this3.settings.get('showTutorial')) {
            _this3.show();
        }
        return _this3;
    }
